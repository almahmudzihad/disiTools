            ...
            <div className='container mx-auto py-20'>
                <footer className="footer sm:footer-horizontal  text-gray-300 py-10">
                    ...
                    <nav>
                        ...
                        <a className="link link-hover">NovaTrack</a>
                        <a className="link link-hover">EcoWave</a>
                        <a className="link link-hover">SwiftDesk</a>
                        <a className="link link-hover">BrightNest</a>
                    </nav>
                    <nav>
